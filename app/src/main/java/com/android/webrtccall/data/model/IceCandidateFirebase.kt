...
data class IceCandidateFirebase(val sdpMLineIndex: Int? = null, val sdpMid: String? = null, val sdp: String? = null) {
    ...
    companion object {
        fun createFromIceCandidate(iceCandidate: IceCandidate): IceCandidateFirebase = IceCandidateFirebase(sdpMLineIndex = iceCandidate.sdpMLineIndex, sdpMid = iceCandidate.sdpMid, sdp = iceCandidate.sdp)
    }
